...
<body>
    ...
    <div class="egesxdluwyjxkx">
        ...
        <header class="idczvrudcgykq iwhffjgzrudkwx">
            ...
            <h1 class="sdduzfpqklx">ХІТ 2023 РОКУ</h1>
        ...
        <section class="rktsokxoqayer">
            ...
            <ul class="wfsdfvsdwrkvz">
                ...
                <li><b>Кольори:</b> ментоловий, чорний, марсала, моко, хакі</li>
        ...
        <section class="cat" id="visadftkiukojav">
            ...
            <section class="cat" id="visadftkiukojav">
                <ul class="qqopqocpveiqls">
                    <li>
                        <div><img src="files/me1.jpg" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/me2.jpg" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/me3.jpg" alt=""></div>
                    </li>
            ...
            <section class="idczvrudcgykq iwhffjgzrudkwx scsefwhcvusdxtl">
                ...
                <br>
                <form id="sicfjuosfjaiua" class="pzgghtazppvd" action="order_915.php" method="post">
